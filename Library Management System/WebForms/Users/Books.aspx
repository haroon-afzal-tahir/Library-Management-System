<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Books.aspx.cs" Inherits="Library_Management_System.WebForms.Admin.Billing" %>
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Books Issued</h6>
                ...
                <div class="col-md-6 mt-md-0 mt-4">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      <h6 class="text-center mb-0">Books Ordered</h6>
                      <span class="text-xs">This Month</span>
                      <hr class="horizontal dark my-3">
                      <h5 class="mb-0">0</h5>
                    </div>
